...
export const INBOXFOLLOWS_SUCCESS = 'INBOXFOLLOWS_SUCCESS';
export const INBOXFOLLOWS_LOADING = 'INBOXFOLLOWS_LOADING';
export const INBOXFOLLOWS_FAILED = 'INBOXFOLLOWS_FAILED';
export const STORY_SUCCESS = 'STORY_SUCCESS';
export const STORY_LOADING = 'STORY_LOADING';
export const STORY_FAILED = 'STORY_FAILED';
export const MESSAGEUPDATE_LOADING = 'MESSAGEUPDATE_LOADING';
export const MESSAGEUPDATE_SUCCESS = 'MESSAGEUPDATE_SUCCESS';
export const MESSAGEUPDATE_ERROR = 'MESSAGEUPDATE_ERROR';
export const SOCKETIO_LOADING = 'SOCKETIO_LOADING';
export const SOCKETIO_SUCCESS = 'SOCKETIO_SUCCESS';
export const SOCKETIO_ERROR = 'SOCKETIO_ERROR';